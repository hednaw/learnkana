...
function randomize() {
  ...
  characterLabel.textContent = Characters[currentCharacter];
...
checkButton.addEventListener("click", function () {
  if (funnyFlag == true) {
    ...
    if (answerInput.value == Translated[currentCharacter]) {
      ...
      console.log(
        "That's not it. Correct answer is: ",
        Translated[currentCharacter]
      );
      infoText.innerHTML =
        "That's not it. Correct answer is: " + Translated[currentCharacter];
